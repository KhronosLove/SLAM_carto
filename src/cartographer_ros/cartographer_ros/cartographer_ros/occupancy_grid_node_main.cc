...
DEFINE_int32(pure_localization,0,"pure_localization !");//add
...
class Node {
 public:
  explicit Node(double resolution, double publish_period_sec, int pure_localization);
  ~Node() {}
...
Node::Node(const double resolution, const double publish_period_sec,const int pure_localization)
...
int main(int argc, char** argv) {
  ...
  ::cartographer_ros::Node node(FLAGS_resolution, FLAGS_publish_period_sec,FLAGS_pure_localization);
